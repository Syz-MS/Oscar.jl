...
global_PHN_index(X::DeterminantalGerm, f::MPolyRingElem) returns the dimension of the vector space R/I.
...
function PHN_index(X::DeterminantalGerm{<:BRT, <:RT, <:AST}, f::MPolyRingElem, p::Vector) returns the number 
of zeros of the 1-form df lying on the regular part of X, that is,  
global_PHN_index(X::DeterminantalGerm, f::MPolyRingElem)-#{singular points of X}* local_PHN_multiplicity(X::DeterminantalGerm{<:BRT, <:RT, <:AST}, f::MPolyRingElem, p::Vector).
...
julia> ponto_P = [QQ(0), QQ(0), QQ(0), QQ(0), QQ(0), 1//2000];

julia> Xtil = DeterminantalGerm(M, 2, ponto_P)
Spectrum
  of localization
    of quotient
...
julia> global_PHN_index(Xtil,f)
30

julia> PHN_index(Xtil,f,ponto_P)
16
