...
Return the $\mathcal{O}_{(X,p)}$-module $T^1_{(X,p)}$ of infinitesimal deformations for the space germ `(X,p)` at the point `p`. 
!!! note
...
!!! note
    When dealing with a hypersurface singularity use the type [`HypersurfaceGerm`](@ref) and the function [`tjurina_algebra`](@ref) to also receive the algebra structure of the T1 module.
!!! note
    When dealing with a complete intersection singularity use the type [`CompleteIntersectionGerm`](@ref) and the function [`tjurina_module`](@ref) for quicker computations.
# Examples
```jldoctest
julia> R, (x,y,z) = QQ[:x,:y,:z]
...
@attr SubquoModule function T1_module(X::SpaceGerm)
  ...
  return SubquoModule(Rk, Im_B1, Im_Df)
end
...
Return the Tjurina number of the space germ `(X,p)` at the point `p`. 
# Examples
```jldoctest
julia> R, (x,y,z) = QQ[:x,:y,:z];
...
Return whether `(X, p)` is a rigid singularity at the point `p`. 
# Examples
```jldoctest
julia> R, (x,y,z) = QQ[:x,:y,:z];
...
Return the $\mathcal{O}_{(X,p)}$-module $T^2_{X,p}$ of obstructions to lifting a deformation of `(X,p)` over a fat point `(T,0)` to an infinitesimal bigger fat point `(T',0)`.
!!! note
...
Subquotient of submodule with 12 generators
  1: u*(e[3] -> e[1]) + v*(e[4] -> e[1]) + z*(e[6] -> e[1]) + u*(e[7] -> e[1])
  2: v*(e[1] -> e[1]) + u*(e[4] -> e[1]) + v*(e[5] -> e[1]) + z*(e[7] -> e[1]) + u*(e[8] -> e[1])
  3: v*(e[2] -> e[1]) + u*(e[5] -> e[1]) + z*(e[8] -> e[1])
  4: -v*(e[1] -> e[1]) + z*(e[3] -> e[1]) - v*(e[5] -> e[1]) + y*(e[6] -> e[1]) - u*(e[8] -> e[1])
  5: u*(e[1] -> e[1]) - v*(e[2] -> e[1]) + z*(e[4] -> e[1]) + y*(e[7] -> e[1])
  6: u*(e[2] -> e[1]) + z*(e[5] -> e[1]) + y*(e[8] -> e[1])
  7: -u*(e[1] -> e[1]) + v*(e[2] -> e[1]) + y*(e[3] -> e[1]) + x*(e[6] -> e[1])
  8: z*(e[1] -> e[1]) - u*(e[2] -> e[1]) + y*(e[4] -> e[1]) + x*(e[7] -> e[1])
  9: z*(e[2] -> e[1]) + y*(e[5] -> e[1]) + x*(e[8] -> e[1])
  10: u*v*(e[3] -> e[1]) + v^2*(e[4] -> e[1]) + u^2*(e[6] -> e[1]) + u*v*(e[7] -> e[1])
  11: v^2*(e[1] -> e[1]) + u*v*(e[4] -> e[1]) + v^2*(e[5] -> e[1]) + u^2*(e[7] -> e[1]) + u*v*(e[8] -> e[1])
  12: v^2*(e[2] -> e[1]) + u*v*(e[5] -> e[1]) + u^2*(e[8] -> e[1])
by submodule with 6 generators
  1: u*(e[3] -> e[1]) + v*(e[4] -> e[1]) + z*(e[6] -> e[1]) + u*(e[7] -> e[1])
  2: v*(e[1] -> e[1]) - z*(e[3] -> e[1]) + v*(e[5] -> e[1]) - y*(e[6] -> e[1]) + u*(e[8] -> e[1])
  3: -u*(e[1] -> e[1]) + v*(e[2] -> e[1]) + y*(e[3] -> e[1]) + x*(e[6] -> e[1])
  4: -u*(e[1] -> e[1]) - z*(e[4] -> e[1]) - u*(e[5] -> e[1]) - y*(e[7] -> e[1]) - z*(e[8] -> e[1])
  5: z*(e[1] -> e[1]) - u*(e[2] -> e[1]) + y*(e[4] -> e[1]) + x*(e[7] -> e[1])
  6: z*(e[2] -> e[1]) + y*(e[5] -> e[1]) + x*(e[8] -> e[1])
